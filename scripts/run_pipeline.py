...
STEPS = [
    ...
    ("04b_fetch_population.py", "Parse population projections CSV"),
    ("08_fetch_gsdp.py", "Parse RBI GSDP Excel"),
    ("05_clean_and_merge.py", "Merge all 4 components + population"),
    ("06_compute_index.py", "Compute z-scores, composite index, and performance index"),
